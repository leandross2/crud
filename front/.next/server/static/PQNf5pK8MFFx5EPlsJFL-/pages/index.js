...
// EXTERNAL MODULE: ./components/template.tsx
var template = __webpack_require__("onBs");
...
// CONCATENATED MODULE: ./components/simpleTable.tsx
...
var useStyles = Object(styles_["makeStyles"])(function (theme) {
  return Object(styles_["createStyles"])({
    root: {
      width: '100%',
...
var simpleTable_SimpleTable = function SimpleTable(props) {
  ...
  var _React$useState = external_react_default.a.useState({
    ...
    message: ''
      ...
      alertBox = _React$useState2[0],
      setAlertBox = _React$useState2[1];

  function openAlertBox(msg) {
    setAlertBox(Object(objectSpread["a" /* default */])({}, alertBox, {
      open: true,
      message: msg
    }));
  }
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return external_axios_default.a.delete("http://localhost:3001/users/".concat(id));
  ...
  return props.data && props.exibir && external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(Paper_default.a, {
    className: classes.root
  }, external_react_default.a.createElement(Table_default.a, {
    className: classes.table
  }, external_react_default.a.createElement(TableHead_default.a, null, external_react_default.a.createElement(TableRow_default.a, null, external_react_default.a.createElement(TableCell_default.a, {
    className: classes.cellDelete,
    align: "right"
  }), external_react_default.a.createElement(TableCell_default.a, {
    className: classes.cellEmail,
    align: "right"
  }, "E-mail"), external_react_default.a.createElement(TableCell_default.a, {
    align: "right"
  }, "Nome"), external_react_default.a.createElement(TableCell_default.a, {
    align: "right"
  }, "C\xF3digo externo"))), external_react_default.a.createElement(TableBody_default.a, null, rows.data.map(function (row) {
    return external_react_default.a.createElement(TableRow_default.a, {
      ...
      "data-id": row.id,
      onClick: removeUser
    }, "x")), external_react_default.a.createElement(TableCell_default.a, {
      className: classes.cellEmail,
      align: "right"
    }, external_react_default.a.createElement(Link_default.a, {
      href: "alterar?id=".concat(row.id),
      className: classes.link
    }, row.email)), external_react_default.a.createElement(TableCell_default.a, {
      align: "right"
    ...
    action: [external_react_default.a.createElement(IconButton_default.a, {
      ...
      onClick: handleClose
    }, external_react_default.a.createElement(Close_default.a, null))]
  }));
};

/* harmony default export */ var simpleTable = (simpleTable_SimpleTable);
...
function (_Component) {
  ...
  function Index(props) {
    ...
    _this.refreshTable = _this.refreshTable.bind(Object(assertThisInitialized["a" /* default */])(_this));
    _this.showTable = _this.showTable.bind(Object(assertThisInitialized["a" /* default */])(_this));
    _this.state = {
      dataTable: null
    };
    return _this;
  ...
  Object(createClass["a" /* default */])(Index, [{
    key: "makeStyles",
    value: function makeStyles(theme) {
      return Object(styles_["createStyles"])({
        button: {
    ...
    key: "refreshTable",
    value: function () {
      var _refreshTable = Object(asyncToGenerator["a" /* default */])(
      /*#__PURE__*/
        ...
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return external_axios_default.a.get('http://localhost:3001/users');
    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(template["a" /* default */], null, external_react_default.a.createElement(Button_default.a, {
        variant: "contained",
        className: styles_["makeStyles"].button
      }, external_react_default.a.createElement(Link_default.a, {
        href: "/cadastro",
        className: styles_["makeStyles"].link
      }, "Novo Cadastro")), external_react_default.a.createElement(simpleTable, {
